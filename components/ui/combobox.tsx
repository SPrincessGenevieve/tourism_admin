...
function ComboboxInput({
  ...
  return (
    <InputGroup className={cn("w-auto rounded-xl", className)}>
      <ComboboxPrimitive.Input
        render={<InputGroupInput className="rounded-xl" disabled={disabled} />}
        {...props}
      />
...
function ComboboxItem({
  ...
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-2.5 rounded-2xl py-2 pr-8 pl-3 text-sm font-medium text-black outline-hidden select-none data-highlighted:bg-gray-100 data-highlighted:text-black not-data-[variant=destructive]:data-highlighted:**:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        "flex min-h-9 flex-wrap items-center gap-1.5 rounded-3xl border border-transparent bg-input/50 bg-clip-padding px-3 py-1.5 text-sm transition-[color,box-shadow,background-color] has-aria-invalid:border-destructive has-data-[slot=combobox-chip]:px-1.5 dark:has-aria-invalid:border-destructive/50",
        className
      )}
      {...props}
    />
